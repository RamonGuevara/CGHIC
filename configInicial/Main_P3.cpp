 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
	 ...
	 view = glm::translate(view, glm::vec3(0.0f,0.0f,-10.0f));
		...
		model = glm::rotate( model, 0.9f, glm::vec3( 1.0f, 0.0f, 1.0f ) ); // use to compare orthographic and perspective projection
		...
		model = glm::rotate(model, 0.8f, glm::vec3(1.0f, 1.0f, 0.0f));
	...
	////	//
	//	for (int x = 0; x <= n; x++) {
	//		float tx = 2.0f, ty = 2.0f, tz = 2.0f, rx=1.0f, ry, rz, ar, sx, sy, sz;
	//		model = glm::mat4(1);
	//		model = glm::translate(model, glm::vec3(tx, ty, tz));
	//		model = glm::rotate(model, 0.8f, glm::vec3(rx, ry, rz));
